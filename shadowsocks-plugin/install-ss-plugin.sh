...
cd /usr/bin
wget -O addss-p "https://raw.githubusercontent.com/arlanstore/Mantap/ipuk/shadowsocks-plugin/addss-p.sh"
chmod +x addss-p
#wget -O shadowhost "https://raw.githubusercontent.com/arlanstore/Mantap/ipuk/shadowsocks-plugin/shadowhost.sh"
#chmod +x shadowhost && shadowhost
wget -O delss "https://raw.githubusercontent.com/arlanstore/Mantap/ipuk/shadowsocks/delss.sh"
cd
...
rm -rf gost-plugin
cd /usr/bin/
wget -O gost-plugin "https://raw.githubusercontent.com/arlanstore/Shadowsocks-Plugin/ipuk/gost-plugin"
wget -O v2ray-plugin "https://raw.githubusercontent.com/arlanstore/Shadowsocks-Plugin/ipuk/v2ray-plugin"
wget -O xray-plugin "https://raw.githubusercontent.com/arlanstore/Shadowsocks-Plugin/ipuk/xray-plugin"
chmod +x gost-plugin
...
wget -O gost-plugin-arm.zip "https://raw.githubusercontent.com/arlanstore/Shadowsocks-Plugin/ipuk/gost-plugin-arm.zip"
wget -O gost-plugin-x86.zip "https://raw.githubusercontent.com/arlanstore/Shadowsocks-Plugin/ipuk/gost-plugin-x86.zip"
wget -O v2ray-plugin-universal.apk "https://raw.githubusercontent.com/arlanstore/Shadowsocks-Plugin/ipuk/v2ray-plugin-universal-v4.44.0.apk"
wget -O xray-plugin-universal.apk "https://raw.githubusercontent.com/arlanstore/Shadowsocks-Plugin/ipuk/xray-plugin-universal-v1.5.4.apk"
