...
# ==================================================
# Link Hosting Kalian
fisabiliyusri="raw.githubusercontent.com/arlanstore/Mantap/ipuk/wireguard"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/arlanstore/Mantap/ipuk/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/arlanstore/Mantap/ipuk/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/arlanstore/Mantap/ipuk/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
